...
namespace KLTN.Game.Presentation
{
    ...
    public sealed class CombatImpactFlashView : MonoBehaviour
    {
        ...
        [SerializeField]
        private Color combatColor = new Color(1f, 0.3f, 0.12f, 1f);

        [Range(0f, 1f)]
        [SerializeField]
        private float peakAlpha = 0.75f;
        ...
        public IEnumerator EaseIn(float duration)
        {
            ...
            yield return AnimateColor(impactFlash.color, targetColor, duration);
        ...
        public IEnumerator FadeOut(float duration)
        {
            ...
            yield return AnimateColor(impactFlash.color, baseColor, duration);
        ...
        {
            if (!initialized || impactFlash == null)
            {
                return;
            }
        ...
        private IEnumerator AnimateColor(Color startColor, Color endColor, float duration)
        {
            if (duration <= 0f)
            {
            ...
            while (elapsed < duration)
            {
                ...
                impactFlash.color = Color.LerpUnclamped(startColor, endColor, eased);
