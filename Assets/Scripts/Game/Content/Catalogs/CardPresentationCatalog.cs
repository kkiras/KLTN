...
namespace KLTN.Game.Content
{
    ...
    public sealed class CardPresentationEntry
    {
        ...
        [SerializeField]
        private Card cardAsset;

        [SerializeField]
        private CardArtworkView artworkPrefab;
    ...
    public sealed class CardPresentationCatalog : ScriptableObject
    {
        ...
        [SerializeField]
        private List<CardPresentationEntry> entries = new List<CardPresentationEntry>();
        ...
        public CardArtworkView Find(string cardId)
        {
            ...
            if (artworkByCardId.Count == 0 && entries.Count > 0)
            {
                RebuildIndex();
            }
